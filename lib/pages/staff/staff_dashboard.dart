...
class MainStaffDashboardLayout extends StatefulWidget {
  ...
  @override
  State<MainStaffDashboardLayout> createState() =>
      _MainStaffDashboardLayoutState();
}
...
class _MainStaffDashboardLayoutState extends State<MainStaffDashboardLayout> {
                          ...
                          Expanded(
                            child: OutlinedButton(
                              ...
                              style: OutlinedButton.styleFrom(
                                foregroundColor: StaffDashboardTheme.textGray,
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          _buildNavItem(
              Icons.people, 'Patients', 0, widget.selectedNavIndex == 0),
          _buildNavItem(
              Icons.person, 'Profile', 1, widget.selectedNavIndex == 1),
          ...
          Container(
            ...
            child: InkWell(
              ...
              child: const Row(
                children: [
                  Icon(Icons.logout,
                      color: StaffDashboardTheme.textGray, size: 20),
                  SizedBox(width: 12),
                  Text(
                    'Log out',
                    style: TextStyle(
  ...
  Widget _buildNavItem(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color:
            isSelected ? StaffDashboardTheme.primaryGreen : Colors.transparent,
          ...
          actions: [
            TextButton(
              ...
              child: const Text('Cancel',
                  style: TextStyle(color: StaffDashboardTheme.textGray)),
            ),
            ElevatedButton(
              onPressed: () => Navigator.pop(context, true),
              style: ElevatedButton.styleFrom(
